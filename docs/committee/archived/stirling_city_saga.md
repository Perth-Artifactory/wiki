...
- SKoT McDonald (`phone number removed`, `email removed`) - Events Manager
- Chris Bashall (`phone number removed` `email removed`) - Events
- Anton Lord (`phone number removed` `email removed`) - Infrastructure Czar
- Jan Iverach (`phone number removed` `email removed`) - Tame Town Planning Consultant (aka "Tim' Gilchrist's Mum")
...
- Direct Telephone (08) `phone number removed` \| Mobile `phone number removed` \| Fax (08) `phone number removed`
- E: `email removed`
- Now her phone is ringing thru to "Kelly"

Geoff Wyber \[November 2012 to June 2013\]

- Planning Compliance \| `phone number removed` (direct line) \| email: `email removed`
...
- 2013:04:10 - Jan responds with much useful advice on current situation (forwarded to committee)
...
- 2013:03:28-11:30am - SKoT writes email reminder note to Geoff Wyber, confirming key points of phone conversation in tracked, written media. (forwarded to committee)
