...
* How to pay your membership and tool usage fees (Your individual transfer code is `TC{{ tidyhq_info.id }}`, this should be used in the description of all bank transfers you make to us)
