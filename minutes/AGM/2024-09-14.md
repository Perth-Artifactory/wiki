...
Because the Association moved to set the number of commitee members to XX members, all XX nominees were automatically declared to be elected.
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Confirm the entrance fees, subscriptions, and other amounts (if any) to be paid by members, XXXXXXXXXXX. | XXX       | XXX          | Accepted unanimously |
