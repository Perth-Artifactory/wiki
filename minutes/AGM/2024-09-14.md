...
Fletcher acknowledged the recent passing of one of our founding members, Daniel Harmsworth.
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Appoint an auditor | XXX     | XXX         | No one called for the motion. |
