...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| **Special resolution:** Adopt the proposed new clause s34.1A as part of our constitution, implementing a “no confidence” mechanism for committee nominations, with the full text as published in the notice of the annual general meeting. | Penny Wood | Vincent Dalstra | Passed by show of hands |
