...
~~[Proxy voting form AGM 2026](/minutes/agm/proxy_voting_form_agm_2026.pdf)~~
...
6.  Other business of which notice has been given as per the rules
    ...
    * Consider a special resolution to amend our constitution, s1 “terms used”, to expand the definition of “direct message”
    * Consider a special resolution to amend our constitution, s1 “terms used”, to add a definition of "written notice" that explicitly includes online platforms

> Everything beyond this point is a work in progress. Please consult the agenda above and the linked written notice.
{.is-warning}

<!-- The below is largely a copy from last year, it'll need to be modified and have the specifics removed ready for this year -->
...
| ----------- | ----------- | ----------------- | ----------------- |
| Confirm the minutes of the previous annual general meeting, held [2025-09-13](/minutes/AGM/2025-09-13) |  |  | Accepted unanimously by show of hands |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Accept the [annual report](/docs/committee/perth_artifactory_annual_report_2025-2026.pdf) |  |  | Accepted unanimously by show of hands |
| Accept the [financial statements](/docs/committee/perth_artifactory_annual_report_2025-2026.pdf) (pages XXXX-YYYY of the annual report) |  |  | Accepted unanimously by show of hands |
...
### Amendments to s1 "terms used"

| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| **Special resolution:** Amend our constitution, s1 “terms used”, to change the definition of *“direct message”* from: *“a message sent directly to a person using the primary online communication platform administered by the Association”*, to: *“a message sent directly to a person using an electronic platform administered by the Association.”* | XXXX | XXXX | XXXX |
| **Special resolution:** Amend our constitution, s1 “terms used”, to add a definition of *"written notice"* as follows: *“written notice has its usual meaning, and also includes a communication or submission sent via an electronic platform operated by the Association.”* | XXXX | XXXX | XXXX |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| **Special resolution:** Adopt the proposed new clause s34.1A as part of our constitution, implementing a “no confidence” mechanism for committee nominations, with the full text as published in the notice of the annual general meeting. | XXXX | XXXX | XXXX |
