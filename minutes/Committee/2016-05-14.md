...
### Previous Action Items
    ...
    *ACTION: SKoTM to post to list re current process for reporting dangerous things Wiki updated. Incidents eg Use of spray paints/solvents has informed the grey areas in the process **Wiki entry done. To be posted out**
    ...
    *ACTION: MitchK to investigate Officeworks printing of (RFID?) membership cards **Not done** SKoTM to take on.
...
-   Swancon have agreed to pay \$1200 as advance hire for sound system for next two years. **Perth Artifactory sound systems (3 amps, 2xPA tops, 2 subs, 3 mixers, assorted microphone stands and cables.)**
...
-   Dan's plumbing explorations - there is a septic, where is unknown, soak wells get OK from Don - WINTER READINESS in general. \*\*Verbal OK from Don. SKotM suggests we ask for a rent-free period during lease negotiations, where we do all the work re soak wells, hot water etc etc. \*\*
...
### Sub-Committee Reports
    ...
    *ACTION: List of subcommittees and mailing lists **NickB to update wiki with details**
...
-   Door 1.6 released - Now checks card list. Roadmap on [GitHub](https://github.com/Perth-Artifactory/doorbot/issues)
...
-   TODO LIST:
    ...
    -   Move critical services onto router (can then be UPS'd if desired)
...
Motion: StuartM Moves we co-opt Lawrence Dixon onto committee. NickB Seconded. No one against. **Carried** **Action: NickB to add Lawrence to groups etc.**
...
ACTION: Check bearing on little red's fan. Not Done ACTION: Interlocks etc continues. Ongoing Action: DaveO(?)Do-not-cut Sign above laser cutters ACTION: DaveO refer to IT subcommittee for technical solution to pinging members before their membership expires Not Done ACTION: SKoT to call for Security subcommittee meeting ACTION: NickB to add Lemming to -ctte groups ACTION: SteveH to add his LSO status to the wiki page
