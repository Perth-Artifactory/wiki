...
-   ACTION: StuartM - Plan to remove lockers and replaced with tubs. **Move to infrastructure meeting**
...
-   ACTION: SKoT to call for Security subcommittee meeting "Lemming, Mitch, Steve, Nick to take on"
...
\* Action: Lemming/NickB/JMM/MitchK to attend Joondalup Kaleidoscope festival information session. **DONE: Some members take on**
...
4.  Standard pricing for non-commercial events is usually \$10 per person up to a maximum of \$150. Review pricing. Factors to consider are if tool usage is required, objection to noise, space requirements, time of day.
    1.  Treasurer proposal (would affect Arduino U nights but not DIY Synth)
...
```
    ...
    * Event Ownership - ie make a particular member(s) responsible for organizing events or liaising for a particular non-member group.  So they are better organised
      * Open Day - Steve
      * Arduino U - Tim
...
##### Action items from previous Infrastructure meeting
...
4.  Standard pricing for non-commercial events is usually \$10 per person up to a maximum of \$150. Review pricing. Factors to consider are if tool usage is required, objection to noise, space requirements, time of day. Treasurer proposal (would affect Arduino U nights but not DIY Synth)
    1.  for groups that don't mind noise and non-commercial
    2.  or interfere with the general working of the place or take it over
    3.  don't use the tools
    4.  \$5 a head.
...
```
    ...
    - Register Laser Cutters????  are our machines registered with the Radiological Council of WA? **yes D.Harmsworth probably has it** Steve asks do you want me to go to the effort of becoming registered with the Radiological council of WA? **(YES) STEVE TO DO THESE THINGS**
...
-   Action: ANDREW to donate three shade sale posts
-   Action: GROUP build a shed post lease negotiations
