...
#### Event Coordinators Report
      ...
      * ADUG - (Coordinator Nick & Richard Harrington)
        *8 people
        *Had an outing to Pawsey Supercomputing Centre
...
-   Extraction needed for electronics work
-   Electronics area outside would be freed up
-   Downside is won't get subtenant but we need to move on from dependancy on that
...
<!-- -->
```
        * Wildcard discussed - about $52 AUD for anything on the Artifactory domain. LetsEncrypt certificate is a single site but is free and expires after 90 days  but recommended to change in cronjob regularly.  Steve and Tim can install. Consensus was go for free LetsEncrypt cert
...
### Other Business
     ...
     *Steve spoke to Flavia from Vic Park collective
        ...
        * Their premises are and old house with outdoor area but is tiny
