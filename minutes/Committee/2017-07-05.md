...
<!-- -->
```
        * Wildcard discussed - about $52 AUD for anything on the Artifactory domain. LetsEncrypt certificate is a single site but is free and expires after 90 days  but recommended to change in cronjob regularly.  Steve and Tim can install. Concensus was go for free LetsEncrypt cert
