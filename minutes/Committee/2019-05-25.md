...
-   <s>New bandsaw blade (Carbatec?) \$20</s>
...
-   Experimental Improv Music Workshop - (Coordinator Brett Cowan **\#**) - **Event Officers agreed to discontinue**
...
-   10 year celebrations
    ...
    -   (STU) Propose slack channel 10Year established for event planning
        -   RTR live stream of NoizeMaschin?
...
1.  <s>The Member Storage Officer is appointed and dismissed by fiat of the Main Committee.</s> *covered in the constitution already*
2.  The Member Storage Officer is responsible for:
...
4.  Materials that over-stay their time, belong to an ex-member **after notice period has elapsed** or are outsize the size limits are subject to being discarded or placed on the hack rack by a Committee member.
