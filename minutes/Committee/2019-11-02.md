...
Participant will attempt to either modify an object to perform the opposite of its original function OR remove the functionality of an object in the most creative way possible. Potential entries include a toaster that cools down toast and a spoon filled with clear resin respectively.
...
1.  An electronic logbook has been created in the GSuite folder "Certificates & Compliance" after been provided with examples of how it should look. Jim's Test and Tag who does our fire extinguishers check is qualified to do this test and is due at the Artifactory this month.
...
-   \$58.30 for post Madman pizza (this item has been added to set a precedent that the Artifactory, and by extension the Promotions Subcommittee chair, can opt to pay for volunteer meals during/after fundraising events.
...
```
    ...
    * Quartermasters
      * Vincent
        * Approximately 600 cans and 80 crisps as of 22 October
    * Membership Officers
      * Nothing
...
Spend \$250 for acquisition of tables.
...
-   Arduino U - (Coordinators: Hugh, Doug) - Cruising along. One guy demanded a lot of time and didnt appear to pay. Hugh.
-   Open Source Hackers (Coordinators: Stephen Price**\#**) - It happened. Mel bunch of people talking

Games

-   ARTIfrag (Coordinator: Iain) - tentatively booked for December open day. Run around 4 times per year.
...
| [Sponsored Memberships Panel](/subcommittee/SponsoredMemberships) | Members: StuartM(/docs/committee/secretary), JasonK, Jean-Michel | apply AT artifactory.org.au           |
...
Working on new doorbot was discussed during Committee Meeting on the 2019.01.30 During committee meeting on 2019.03.30, we approved \$200 for 5 prototypes Lemming was reimbursed \$40.12 and \$184.35 in April 2019 However, there has been no outcome and the last update was during Committee Meeting 2019.06.05: Lemming, RFID door locks: no changes

\- (Stu) - emailed Lemming. Two are waiting on people to install software - (Stu) - until committee meeting we were getting regular status updates. - (Stu) - Original proposal was for bandroom
...
A member has been behaving poorly within the space. More details will be added closer to the meeting as witnesses are contacted. The agenda item has been deliberately anonymised until the committee decides otherwise.

Discussion -Noted history of multiple previous incidents.

     -collated into a committee-only Google doc.
...
-   **Specialist Correspondant**: The Committee may appoint another member who is known to have skills within the area of the project to verify viability if the committee cannot determine this within their own skill set
