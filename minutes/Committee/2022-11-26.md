...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Redefine sponsored membership panel to cover all associate memberships as per https://github.com/Perth-Artifactory/wiki/pull/11/files | Fletcher       | Beau          | Accepted/Rejected |
