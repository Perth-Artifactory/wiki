...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Accept the revised subcommittees bylaw, to take effect from 2023-01-31. | Lewis       | Renee          | Accepted/Rejected |
...
| Start negotiating tool agreements for existing loans | Infrastructure Subcommittee | Ongoing |
| Submit ACNC report by 2023-01-31 | | |
...
| Address members not getting invoices due to not being part of invoicing groups. (See #committee_bank) | | |
| Action expired members to remove their property | | |
| Set up new board game night events on Google Calendar, Facebook, Meetup. | Lewis | |
| Obtain big packets of snacks for Board Game Nights | | |
| Return comments on draft constitution to secretary by 2023-01-14 | Interested committee members | |
| Implement revised subcommittees bylaw on wiki; notify to affected subcommittees | Lewis | |
