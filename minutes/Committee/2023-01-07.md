...
* Emergency lighting and fire equipment maintenance
...
* Swap positions of lockers in kitchenette vs. racking for brewing equipment.
...
* Meetup events
    * Audit to ensure that Meetup / Facebook events align with the events we are actually running.
...
* Board game nights - revive?
    * Lewis to host
    * Say 2nd Saturday of the month from 5pm - 9pm (after General Hacking session.) First one would be 14th Jan.
    * $5 or $10 entry fee (less than day pass rate of $15, requires approval)
    
* Working bees
    * a.k.a. "Cleanup days" or "Improve the Artifactory days"
    * JC, Lewis keen
    * Suggest last Saturday of the month (so space looks good on Open Days on first Saturday of following month)
...
* Discussion in #governance on Slack.
...
| Announce changes via Slack #announcements      | Lewis |
