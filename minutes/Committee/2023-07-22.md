...
| Anything that relates to a specific person. | Pros | Cons |
| At committee member's discretion | | |
| ???  | Pros | Cons |
| ???  | Pros | Cons |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Adopt Loomio as the primary method for online committee decision making and deliberation | Fletcher       | Phoebe          | Accepted/Rejected |
| Adopt the permission structure selected above | Lewis       | Pheobe          | Accepted/Rejected |
...
Make it run by #infra and decide some focus topics for each event beforehand.
...
Action - close out after the meeting.
...
Lewis to draft further revision for delegation of absentes
