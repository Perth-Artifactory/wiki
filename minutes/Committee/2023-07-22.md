...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Adopt Loomio as the primary method for online committee decision making and deliberation. To take effect immediately. | Fletcher       | Phoebe          | Accepted/Rejected |
| Adopt the permission structure selected above. To take effect immediately. | Lewis       | Pheobe          | Accepted/Rejected |
