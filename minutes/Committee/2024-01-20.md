...
* Concerns communicated via email and will be addressed.
...
Authorised trainers are appointed by adding them to a group (@trainers) on Slack. This gives them admin access to Training Tracker and adds them to the #infra-training channel.
