...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Approve Renae to run the course, have priority use of the space, and be paid as proposed. | MOVER | SECONDER | STATUS |
| Authorise Renae to spend up to $360 for materials ($300 expected) and $300 for tools ($250 expected) to prepare for woodworking short course. | MOVER | SECONDER | STATUS |
