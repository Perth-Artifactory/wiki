...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Approve Full Membership for Seb Davidson | MOVER       | SECONDER          | Accepted/Rejected |
| Approve Full Membership for Rakesh Parikh | MOVER       | SECONDER          | Accepted/Rejected |
| Approve Concession Membership for Tom Welman | MOVER       | SECONDER          | Accepted/Rejected |
| Approve Concession Membership for Katrina Italiano | MOVER       | SECONDER          | Accepted/Rejected |
