...
We have a significant amount of membership invoices which are overdue. Some members are historically irregular payers. Many new members expect memberships to be paid automatically or just never return but continue to be invoiced. Some require special effort by the membership officer to send out in particular ways. We are also recovering from some administrative errors here a group was double invoiced, so their membership is renewing a month in advance, and some annual invoices which were issued with an incorrect year in the due date.
