...
* High volume of email enquiries.
  ...
  * Thank you Fletcher, JC, and Renae for help answering recent tricky enquiries.
...
Propose adding the following to the [Training](/docs/policies/training) policy:
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Amend the training policy as proposed. | MOVER       | SECONDER          | Accepted/Rejected |
...
> **Training expiry and refresher training**
>
...
> * The tool has been significantly modified since their last training, or
> * The operating procedures for the tool have changed significantly since their last training.
>
> The authority which sets the training requirements for the tool will determine if refresher training is required, on a risk assessment basis.
>
> If refresher training is required, at least 1 month's notice will be provided to authorized operators, before their authorization expires.
...
>
> Trainers are appointed, and training requirements are determined, by the following subcommittees:
>
