...
| ----------- | ----------- | ----------------- | ----------------- |
| Accept previous meeting minutes | Fletcher       | Renae          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Authorise Fletcher to spend up to $200 AUD for 2 sets of laser safety goggles. | Renae       | Ben          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Add refresher training and training expiry section to training policy, as proposed. | Fletcher       | Tegan          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Modify the tool inductions bylaw, infrastructure subcommittee terms of reference, and training policy as proposed above. | Fletcher       | JC          | Accepted/Rejected |
| Modify the 3d printers subcommittee terms of reference as proposed above. | Fletcher       | JC          | Accepted/Rejected |
