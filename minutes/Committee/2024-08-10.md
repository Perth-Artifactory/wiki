...
🟢 A number of big tool purchases during the month funded by member donations: 3D Scanner, Wood Bandsaw, Track Saw and Soldering Station. (❓ And fibre laser?)
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Approve all new memberships above | MOVER       | SECONDER          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Add training expiry and refresher training section to training policy, as proposed. | MOVER       | SECONDER          | Accepted/Rejected |
