...
* We have received the yearly request for updated information for our insurance.
  * ACTION - Gather required insurance info - Fletcher.
...
| Motion Text                                          | Moved by    | Seconded by       | Status            |
| ---------------------------------------------------- | ----------- | ----------------- | ----------------- |
| Approve up to $250 to purchase a new laser extractor | Fletcher    | Lewis             | Accepted/Rejected |
...
| Delegate project approval authority to Blake Samuels     | Fletcher       | Lewis             | Accepted/Rejected |
| Delegate project approval authority to Doug Bateman      | Fletcher       | Lewis             | Accepted/Rejected |
| Delegate project approval authority to Steve Hodges      | Fletcher       | Lewis             | Accepted/Rejected |
| Delegate project approval authority to Stewart Greenhill | Fletcher       | Lewis             | Accepted/Rejected |
