...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Replace the [Dangerous Projects and Tools policy](https://wiki.artifactory.org.au/en/docs/committee/dangerous_projects_and_tools_policy) with the Dangerous Projects policy as written | Fletcher       | SECONDER          | Accepted/Rejected |
