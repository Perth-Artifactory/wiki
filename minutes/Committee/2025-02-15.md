...
* JC on behalf of MartinG : advises room left in mess, particularly PA system cables unplugged and left in mess. posted in slack and fb rehearsal group room.
  * Fletcher confirmend not related to any infrastructure, has reached out to Aaron.
  
  
Further Discussion :

- Do nothing—members remain frustrated.

- Make band representatives accountable for the state of the room at the end of their session, as is expected in other areas of the space.

- Raise the band room fee to better reflect market rates, with increased revenue subsidising volunteer member time for cleaning and tidying.

- Assess whether the band room (currently occupied by two bands paying $100/month each) provides sufficient benefit to the space or if it could be repurposed for alternate projects, given the premium on space.


 * Action: JC to advise band reps of commitee discussion and highlight that same rules apply as rest of Artifactory. Keep it clean and tidy.
