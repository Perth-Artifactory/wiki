...
| Designate Blake Samuels as an approved person | Fletcher       | SECONDER          | Accepted/Rejected |
| Designate Doug Bateman as an approved person | Fletcher       | SECONDER          | Accepted/Rejected |
| Designate Steve Hodges as an approved person | Fletcher       | SECONDER          | Accepted/Rejected |
| Designate Stewart Greenhill as an approved person | Fletcher       | SECONDER          | Accepted/Rejected |
...
Vehicle fitouts (and the attendees that do them) take up a disproportionate amount of volunteer time and Artifactory resources. Then as soon as the project is comleted they leave to go travelling. Vehicle fitouts should require committee approval and largely should only be considered if:
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Require vehicle fitouts to be approved by the committee | Fletcher       | SECONDER          | Accepted/Rejected |
