...
| ----------- | ----------- | ----------------- | ----------------- |
| Accept the 2024-12-14 minutes as presented | Fletcher | Lewis  | Accepted/Rejected |
...
* ACTION - Gather required insurance info
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Accept Expenses as reported above | Fletcher | Lewis | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Accept all membership applications listed above | Fletcher | Lewis | Accepted/Rejected |
...
1. Make band representatives accountable for the state of the room at the end of their session, as is expected in other areas of the space.
1. Raise the band room fee to better reflect market rates, with increased revenue subsidising our time spent cleaning and tidying.
1. Assess whether the band room (currently occupied by two bands paying $100/month each) provides sufficient benefit to the space or if it could be repurposed for alternate projects, given the premium on space.
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Replace the [Dangerous Projects and Tools policy](https://wiki.artifactory.org.au/en/docs/committee/dangerous_projects_and_tools_policy) with the [Dangerous Projects policy](https://wiki.artifactory.org.au/en/testing/drafts/dangerous_projects) as written | Fletcher | Lewis | Accepted/Rejected |
...
| ---------------------------------------------- | --------------- |
| Update wiki                                    |                 |
| Update website                                 | Joshua/Fletcher |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Bar day pass attendees from working on projects covered by the Dangerous Projects policy | Fletcher       | Lewis          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Require vehicle fitouts to be approved by the committee. Committee to follow application guidance as written. | Fletcher | Lewis | Accepted/Rejected |
...
* The member acknowledges their mistake and that this was not the first time they'd failed to follow our operaitng procedures
