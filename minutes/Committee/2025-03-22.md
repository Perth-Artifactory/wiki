...
This is a placeholder for a slew of by-law updates that can be viewed on [Github](https://github.com/Perth-Artifactory/wiki/compare/main...bylaw-cleanup?diff=unified&w=). They will be translated into a more human readable format soon.
...
| Action Items                                   | Who  |
| ---------------------------------------------- | ---- |
| do/buy/make/implement the thing. By xx/xx/2025 | John |
