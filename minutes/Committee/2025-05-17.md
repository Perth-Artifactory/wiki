...
| ----------- | ----------- | ----------------- | ----------------- |
| MOTION TEXT | Lewis       | Fletcher          | Accepted/Rejected | 🔴
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Accept Expenses as reported above | Fletcher       | JC          | Accepted/Rejected |
| Approve $150 for purchase of lights for the courtyard shed *(from lapsed Loomio motion)*                | Fletcher       | JC          | Accepted/Rejected |
| Approve $300 for purchase items to organise office from the General Fund *(from lapsed Loomio motion)*  | Fletcher       | JC          | Accepted/Rejected |
| Approve $40 to repair yellow fridge trolley wheels | Fletcher       | JC          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Accept the membership applications listed above | JC       | Tegan          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Accept the membership applications listed above | JC       | Renae          | Accepted/Rejected 1 abstained. |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Issue 24/7 key to Liron Koren | Fletcher       | Renae          | Accepted/Rejected |
...
* Supanova confirmed
  ...
  * ⚠️ Ben Request for help with large CNC routed display item (topographic map)
  * ⚠️ Tegan will do some market research into what kind of merchandise we can make that is related to the Supanova celebrity list. Next couple of days please.
