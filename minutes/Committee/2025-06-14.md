...
Next meeting: [2025-07-19](/minutes/Committee/2025-07-19)
...
* Ben - CNC routed topographic map for Supanova display.
  * Fletcher will follow up with Ben
...
* 🟡 Re order flyers - stick with same design for now.
...
* New woodworking tools have arrived in the space
  ...
  * Air filter
    ...
    * Right now toggled on/off with button near trestle tables or kiosk but will look at automation etc soon
  * Drum Sander
    * This tool was donated
    ...
    * Upskilling sessions were optional but users had to agree they were comfortable with changes
      * Discussed - would prefer to sell this. Offer to people who pledged to it first, then members, then general public.
  * SawStop Table Saw
...
* 🟢 Open Day (Coordinator: Fletcher) - Busy, several converted to members.
  * How to give a tour guide - discussed and seems like it would be a good idea to run a training session for how to give a tour. Fletcher would like to participate in this.
* 🟢 Metal Monday (Coordinator: Ben, Lewis) - Mix of busy/quiet
* 🟢 Wednesday Woodworking (Coordinators: Renae, Penny) - Going well - quiet - business as usual. Alice is now on board as a volunteers for this event.
...
* 🟢 Fine Woodworking Association visiting us next Wednesday.
...
[Sovol SV08](https://www.kickstarter.com/projects/sovol/sovol-sv08-max-high-speed-large-size-3d-printer-open-source/description):
...
* Sovol is a well known brand that has consistently released reliable printers for a number of years. 
* The printer uses fairly industry standard control software (Klipper) that is supported by a number of slicers.
* The printer is being released on Kickstarter, this appears to be purely a marketing tactic and the vibe from the community is that units are ready to ship.
...
* Next meeting: 2025-07-19, 13:30 5 weeks

Minutes: [2025-07-19](/minutes/Committee/2025-07-19)
