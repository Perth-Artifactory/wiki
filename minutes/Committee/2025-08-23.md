...
Ren has organised for experienced friends to help prepare for, and run the day. Penny also has experience with running these.

Ideally we will have enough volunteers to run an Artifactory sales/promo table alongside the BBQ. 

### Pride Fairday
48We have applied to have another stall at pride Fairday, after our success last year. 
