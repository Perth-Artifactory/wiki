...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Delete outstanding invoices for terminated memberships listed above | Renae       | Anna        | Accepted/Rejected |
...
* A member started trailing a bed underframe
...
* No significant progress on Modix, next step requires a drive to Capril the current volunteers can't complete themselves
