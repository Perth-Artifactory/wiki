...
| ----------- | ----------- | ----------------- | ----------------- |
| Accept minutes | Renae       | SECONDER          | Accepted/Rejected |
...
* (Continuing from previous month) - RE: A member left the space abruptly during laser cutting
  ...
  * The member does not believe that their previous behaviour is an issue.
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Delete outstanding invoices for terminated memberships listed above | Renae       | SECONDER          | Accepted/Rejected |
...
Square still locking us out, Fletcher working on. Need to test terminals
