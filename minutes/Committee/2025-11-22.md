...
- Lewis, Renae, Fletcher - Draft changes to expense approval bylaws regarding a) delegated expense limits for subcommittees, and b) delegations from the treasurer. :clock3: - See other business 
  * Resolved by other means. Closed.
...
* Rent increase - has been actioned.
* Incoming email from Bunnings - no action required.
...
* Thank to everyone that helped with Bunnings! And good luck at the fair tomorrow!
* Great to see use of the token system is accelerating.
  * 470h recorded for October, already at 460h for November - haven't investigated whether this is significant uptick in new volunteers or skewed by specific people. (There's a bit of a outlier/Spiders Georg situation that makes some processing difficult, we're working on a solution.
...
xxxxxxxxxxxxxxxxx
| Motion | 
| Richard Hatwell - RFID key | Anna Whitlock | Johannes Chuah | Accepted |
...
* Work on the design HUD continues, most functionality is there and the system is in use
  ...
  * Should we introduce the same system to other areas of the space? (eg, machine room)
    * Discussed - machine room, craft room, laser area
...
* Work on a member portal has begun
  * This wasn't a planned project, it just kinda started
  * Ready for supervised testing now but otherwise please leave it alone (access fills up the logs in confusing ways when debugging)
  * At some point in the next six months will likely require the org to pay for a MYOB subscription ~$50/mo to develop certain features. (cost will be offset by savings down the line)
...
* Our new gas bottles have arrived
  ...
  * ACTION - Signage required to shed.
* Work on the craft room has begun
  ...
  * Call out for donations for the room fitout

### 3D Printers Subcommittee

* The influx of interested members is causing a bit of a delay in training
...
* General Hacking Day (Coordinator: Committee) - Busy but running well
* Open Day (Coordinator: Fletcher) - Running well, the latest wave of volunteers has settled in
* Metal Monday (Coordinator: Ben, Lewis) - Active as a general workshop event.
* Wednesday Woodworking (Coordinators: Renae, Penny, Alice) - 
  * Small regular group forming, have introduced weekly lunches.
  * 1 new membership.
  * Thanks Fletcher for helping out.
* Showcase Saturday (Coordinator: Fletcher) -
  ...
  * ACTION: Check in with Ben Connor - maybe can run taps and dies again, filing and fitting?
...
* Next meeting: Sunday 2025-12-14, 13:00 4 weeks, Online

Minutes: [2025-12-14](/minutes/Committee/2025-12-14)
