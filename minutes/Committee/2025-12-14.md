...
Moral in the space appears to be high, things are running (mostly) smoothly :)
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Write off invoces for terminated memberships reported above | Renae     | SECONDER          | Accepted/Rejected |
...
- While the panel is set up to *"Act as the sole selection/approval panel for all associate class memberships unless otherwise delegated"* it seems appropriate to open this up to feedback from full committee, as there will be a significant training impost on people outside the panel (lasers, 3D printers)
- The panel is split: 1 for, 2 against.
- Email sent to Fletcher and Lewis (as trainers for lasers and 3D printers) to provide feedback.
...
* Showcase Saturday (Coordinators: Fletcher) - Thank you to Lewis for running a session on sand blasting :) (he'll add points here)
...
| Appoint Fletcher Boyd as the chairperson of the IT Subcommittee. | MOVER       | SECONDER          | Accepted/Rejected |
| Appoint Tom White as the chairperson of the 3D Printers Subcommittee. | MOVER       | SECONDER          | Accepted/Rejected |
...
| Motion Text | Moved by    | Seconded by       | Status            |
| ----------- | ----------- | ----------------- | ----------------- |
| Issue RFID key for member Jackson Harvey | MOVER       | SECONDER          | Accepted/Rejected |
| Issue RFID key for member Calum McKnight | MOVER       | SECONDER          | Accepted/Rejected |
