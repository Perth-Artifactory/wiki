...
Next meeting: [2026-04-06](/minutes/Committee/2026-04-06)
...
| ----------- | ----------- | ----------------- | ----------------- |
| Accept the minutes of the previous meeting  | Renae       | JC          | Accepted |

### Review Previous Meeting's Action Items

* Lewis Peaty - ACTION - Follow up with Tylar Gill
  * Followed up, no response. Terminate. ACTION - Renae.
* Fletcher - ACTION - add more signage to reinforce new chocolate pricing
  * Pending - ACTION - Fletcher to delegate.
* Lewis Yip - ACTION - follow up with Tegan regarding sale of 3D printed toys.
  ...
  * Tegan has had a chat with Dan, this will no longer be happening.
...
* Lewis Yip - ACTION - Amend keyholder induction to include: require keyholders to run visitor inductions / visitor signup process, for people they bring into the space.
  ...
  * ACTION - Fletcher to write up the tech solution so that this can tbe implemented.
...
|---------------------|---------------------|-------------------------------------------------------------------------------------------------------|---------------------------------|----------|---------------------------------------------|---------------------------------------------------------------|
| 2026-02-18 03:31:30 | 2026-02-21 04:01:06 | Approve $200 for purchase of materials to extend the courtyard festoon lighting                       | 👍: 8<br>👎: 0<br>🤷‍♂️: 0<br>👻: 1 | ✅Passed  | `Not yet entered`                           | [View on Loomio](https://vote.artifactory.org.au/d/NaHU3LOx/) |
| 2026-02-07 16:08:20 | 2026-02-10 17:01:44 | Approve $250 for purchase of lights from the Infra fund                                               | 👍: 9<br>🤷‍♂️: 0<br>👎: 0         | ✅Passed  | `Not yet entered`                           | [View on Loomio](https://vote.artifactory.org.au/d/NaHU3LOx/) |
| 2026-01-25 01:25:09 | 2026-01-25 15:13:07 | Motion: Reject Hugo Ochre's Full Membership application                                               | 👍: 9<br>🤷‍♂️: 0<br>👎: 0         | ✅Passed  | Fletcher has reached out to Hugo            | [View on Loomio](https://vote.artifactory.org.au/d/freAPYS7/) |
| 2026-01-24 08:49:18 | 2026-01-27 08:00:43 | Approve $122.40 for purchase of plates and bowls from the Infrastructure and Equipment Fund           | 👍: 9<br>🤷‍♂️: 0<br>👎: 0         | ✅Passed  | `Not yet entered`                           | [View on Loomio](https://vote.artifactory.org.au/d/JcYUfk4D/) |
...
* Restock shelf will help with the physical labour of restocking

### Membership Officers

* Business as usual
* Updating the visitor induction to track the changes to the new member induction.

### Membership Storage Officer

* Lewis Peaty has audited and is actioning stale locker assignments.
* Outstanding request from Michael Adams for a storage locker - defer until he has completed new member induction.
* Investigating long material storage options.
* Sheet material audit in progress.
...
* New head is in, has made alignment easier
* Bed cleaning plan is pretty much done
  * Will clean the old bed first

### IT Subcommittee

* Feedback on laptop workstations has been positive
* We've migrating a lot of things away from Azure
  * Were previously on Azure because "why not" (free credit)
  * We've identified another potential use for Azure credits

#### Portal

* Announcement system added
* Training booking system tentatively in place
* Better tracking of training documentation
* Other features in the [changelog](https://git.artifactory.org.au/Perth-Artifactory/member_portal/src/branch/main/CHANGELOG.md)

### Promotions Subcommittee

* Bunnings - Balcatta Easter Family Night - Thu 26 Mar 6pm - 8pm
  * ACTION - Renae - Contact Conti regarding soft drinks for Balcatta Easter Family Night - Thu 26 Mar
...
* Training doc stats has helped identify gaps
* Oxy is up and running, docs are on second iteration
* Vending machine is gone
  * Door has been preserved
* Restock shelf is in place
  * Consumables wall will come after
* Progress has been made on cleaning up the courtyard
  * New workbench outside, will need perm topping soon (formply)
* Festoon lights are up in the courtyard
  * Needs more power
  * Looks good regardless
* Replacement crockery has been purchased
  * Will store old items for large events (>24)
* Courtyard - misting system.
...
* Board Game Afternoon (Coordinator: Anna, Ilke, Tom) -
  * Recent event was well attended (about 6 participants). 
  * New board games have been donated to the space that are a better fit for the event.
  * Board games crew is intending to cull the board games collection, to focus on board games that actually get played in the space.
...
* DIY Synth (Coordinator: Nathan Thompson, Andrew nonlinearcircuits) - Did not run (event host sick)

### General

* General Hacking Day (Coordinator: Committee) - Business as usual
* Open Day (Coordinator: Fletcher) - Good ratio of visitors to sign ups
* Metal Monday (Coordinator: Ben, Lewis) -
  * Recent Metal Mondays have been well attended.
  * Upcoming event extended due to public holiday
* Wednesday Woodworking (Coordinators: Renae, Penny) - 
  * Healthy attendance with people doing cool stuff.
* Showcase Saturday (Coordinators: Fletcher) - 
  * Feb went well, thanks Doug!
  * Lewis will run t-shirt vinyl as the next event with Spondy. 
...
* Lewis Yip is leading this.
* Event to be run in June / July.
...
* We have cut our prices for 3D printed widgets by 50% at White Dwarf Books
* Stock still isn't moving.
* A member is currently designing a tabletop gaming related product, that may sell better to the White Dwarf Books audience.
...
* Next meeting: 2026-04-06, 13:30 4 weeks

Minutes: [2026-04-06](/minutes/Committee/2026-04-06)
