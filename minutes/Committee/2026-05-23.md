...
Next meeting: [2026-06-20](/minutes/Committee/2026-06-20)
...
* ✅ ACTION - Fletcher - Liase with Tom regarding filament in Pride colours
  * Filament from a new supplier has been handed out to testers, feedback positive so far
...
* In discussions with Melbourne PC Users group - they want to expand into being a makerspace - Fletcher has been corresponding with them.
* Women on the Tools have taken a tour of the space with the view to running some courses here. Proposal from WOTT to come. Woodworking, welding. Renae coordinating.
* Invited to WA Mens Shed Association meeting - couldn't make it on short notice but Fletcher is exploring further contact here.
...
* Dremel lock pin
  * Root cause not identified, could be overload on tool
  * Bosch sending a replacement pin
* Trim router collet
  * Root cause could be overload on tool, wrong bits fitted (6mm vs 6.35mm) or collet not tightened enough.
* Nearby structure fire
  * A member was working in the courtyard with earphones in (couldn't hear door), phone muted (didn't get phone calls), and a respirator on (couldn't smell smoke).
  * Emergency services were unable to clear the building
  * We eventually got their attention by pulsing the lights
  * The member was unharmed
  * A locally and remotely activated evacuation siren would have likely solved this issue
  * Evacuation trigger point at the laser cutters.

## Property Report

* NBN upgrade - FTTP - first inspection next Friday.

## Chairperson's Report

* Business as usual, thanks all for keeping the space running.

## Treasurer's Report

The Treasurer's Disclaimer: The numbers below have been calculated in a quick way and have not undergone robust checking as for an Annual Report.

* Significant expenditure of just under $4,000 for our annual insurance bill this month, along with a $1,500 drink/chocolate restock.
* Many new members are not making their payments on the terms as covered in their new member induction, which is creating significant admin work. Further write off of unrecoverable membership debt listed below.
* Infrastructure fund will be down to around around $500 after the new compressor is drawn from it next month. Suggest a pre EOFY drive to increase funds, noting that Kitchen and Craft room projects still remain unfunded.
* $5,000 was drawn from the secure fund to cover the insurance bill, a further $5,000 is drawn in May to pay for the new air compressor.
* Suggest future expenses be considered carefully for now, noting membership numbers have moved downwards. 
...
* Bar reconfiguration has allowed us to maintain higher levels of stock, reducing volunteer load
* Seems to be business as usual otherwise
* Need to watch expiry dates (have lost some stock due to expiriy dates a few months ago.)

### Membership Officers

* Pipeline into new member induction has been strengthened, new members now have a direct booking link at the top of their welcome email.
...
* We are likely going to require a new tube for Big Red in the next 3-4 months
  * Tube cost will be $1,000 - $1,500, the quoted shipping cost is 2-3x on top
  * Working with other logistics suppliers to bring that cost down
* Bed cleaning bath nearing completion
  * Pieces for frame have been printed and purchased
  * Still have to cut the PVC
  * Still have to find lining material
* We've tested the new compressor with full flow on Big Red
  * Works great
  * Will need to work on solenoid for auto switching (avoid compressed air noise while laser door is open)

### IT Subcommittee

* The new UPS is ready to be put in as of today, will significantly reduce workload following power disruptions
* Portal work continues
  * Current method is building out the backend of various features then call for volunteers to help with data
  * Started on a Google Workspace CRM connector
* Xero migration
  * Hit a stumbling block with TidyHQ
  * Fletcher is working directly with TidyHQ to resolve

### Promotions Subcommittee

* Supanova coming up.
* Pride later in the year.
  * 3D printing starting today.
...
* Work on the new workbenches continues
  * Taking a bit longer than expected (sickness, a measuring mistake)
  * First bench is in place and is actively being used (segmented bench, LHS courtyard)
  * Second bench will be up and running next week (wheeled, moving between project area and courtyard)
    * Also serves as an outfeed for the tablesaw
  * Third bench has no current hard deadline, likely 4 weeks (square, RHS courtyard)
  * Fourth bench is likely two weeks from starting on the top (social, most of the work will be in the top vs the other tables)
  * Thinking on options for dog holes (fixturing holes) in the new workbenches
* Courtyard was further cleared up
  * Old bench containing scrap metal has been removed
  * The drainpipe behind that bench doesn't go anywhere
* New compressor is in the shed
  * Has been the primary compressor since Wednesday
  * Will likely need to explore alternate placement by summer
  * Modifying the air line from the shed to the building will increase output (Larger line to building direct into manifold)
  * Haven't tested with sand blaster, plasma cutter yet (other pain points with old setup)

### 3D Printers Subcommittee

* Large filament restock underway
  * Filament for sale items at Supanova/Pride
  * Filament for space printing
  * Trial of new supplier (local)
  * Some colour restock
  * Bulk restock of black/grey/white
    * Hope here is this should reduce the printing in random colours for test prints
...
* Digital items grant
  * Progressed to next round, applications close 5:00pm AEST on Friday 29 May 2026
...
* Arduino U - (Coordinators: Blake, Stewart) - Busy, no clear indication as to what changed

### Social

* Talkshop Wednesday (Coordinator: Fletcher, Steve) - Thank you to Lewis for standing in
* Saturday Lunch (Coordinator: Fletcher, Steve) - Business as usual
* Board Game Afternoon (Coordinator: Anna, Ilke, Tom) - 2 non member attendees, stuck around to play games together after the event. One had been to the space before, the other was brand new and found us through meetup.
...
* Wednesday Woodworking (Coordinators: Renae, Penny, Alice) - Running well, Lunch continues to be a high point of the event.
* Showcase Saturday (Coordinators: Fletcher) - Did not run

### Other

* Vaccination Day (Coordinators: Penny, Fletcher) - Went really well, will run again next year with a goal to expand.
...
* Will make minor changes and then put up for vote to accept.
...
* CDC has handed out many flyers.
  * So far as we know, we haven't had any of those people attend an Open Day or make contact with us yet.
...
* Next meeting: 2026-06-20, 14:00 4 weeks

Minutes: [2026-06-20](/minutes/Committee/2026-06-20)
