...
* Infrastructure fund will be down to around around $500 after the new compressor is drawn from it next month. Suggest a pre EOFY drive to increase funds, noting that Kichen and Craft room projects still remain unfunded.
...
| Approve a further $500 for workbench and feast table adaptions costs (total $1,500) | MOVER       | SECONDER          | Accepted/Rejected |
...
* We've tested the new compressor with full flow on Big Red
  * Works great
  * Will need to work on solenoid for auto switching
