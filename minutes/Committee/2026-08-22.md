...
My back of the envelope calculations are that this action would bring in an extra $4,000 next year, growing slightly each year. 

Legacy members would also be encouraged to increase their monthly payments by adding a regular tax deductable donation.

Had we done this last year, we still would likey have fallen short of our target, however I'm not sure there is appetite to raise it any further at this time. I do think it likely we will need to make a similar incremental increase in following years.


### Amend expenses bylaw

Motion text - Add the item "Accounting software subscription fees" to the list of things able to be authorised/paid by the treasurer 
Moved by Ren
